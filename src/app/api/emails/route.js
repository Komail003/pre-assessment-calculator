        ...
        * {
        ...
        <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <div style="font-family: "Raleway",sans-serif; line-height: 140%; text-align: justify; word-wrap: break-word;">
            <p style="line-height: 140%;text-align: justify;">We have received a completed Online Discovery Form  for <strong> ${PersonalData.preferredName}</strong> through our website.  Attached is a copy of their  results.  The clients details are as follows:</p>
          </div>
                      ...
                      <table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;" border="1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td style="padding: 10px;">${PersonalData.firstName || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerFirstName || ""}</td>
                          </tr>
                          <tr>
                            <td style="padding: 10px;">Surname</td>
                            <td style="padding: 10px;">${PersonalData.surName || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerSurName|| ""}</td>
                          </tr>
                          <tr>
                            <td style="padding: 10px;">Preferred Name</td>
                            <td style="padding: 10px;">${PersonalData.preferredName || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerPreferredName || ""}</td>
                          </tr>
                          <tr>
                            <td style="padding: 10px;">DOB</td>
                            <td style="padding: 10px;">${PersonalData.DOB || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerDOB || ""}</td>
                          </tr>
                          <tr>
                            <td style="padding: 10px;">Email</td>
                            <td style="padding: 10px;">${PersonalData.email || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerEmail || ""}</td>
                          </tr>
                          <tr>
                            <td style="padding: 10px;">Phone Number</td>
                            <td style="padding: 10px;">${PersonalData.phoneNumber || ""}</td>
                            <td style="padding: 10px;">${PersonalData.partnerPhoneNumber || ""}</td>
                          </tr>
                        </tbody>
                      </table>
